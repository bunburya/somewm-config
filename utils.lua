...
function utils.format_bytes(bytes, use_binary)
...
function utils.parse_free(output)
...
function utils.parse_df(output, mountpoints)
...
function utils.parse_net_dev(output)
